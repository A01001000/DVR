...
* SPAC: First run spac-data.slurm & spac-data-test.slurm to fix data format for this model then run spac-l2r.slurm, spac-mrxfdg.slurm, & spac
...
3. The variants of the model are in the other dvr folders for you to alternatively try out as well. 
