...
```
2. Go to the main 'slurm' directory to run the main DVR model in 'dvr2' with curriculum learning. 
...
For the these, use the modify the import statements in main2.py accordingly to try these versions (ex. 'from dvr2.vlearn_rob import train_vlearn' -> 'from dvr-spac-hybrid.vlearn_rob import train_vlearn').
