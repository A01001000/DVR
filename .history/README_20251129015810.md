...
1. Oneshot registration w/ Dino: oneshot-l2r.slurm & oneshot-mrxfdg.slurm
2. Vlearn Registration with raw images: raw-img-l2r.slurm & raw-img-mrxfdg.slurm
3. Registration with intermediate layers: int-layer-l2r.slurm & int-layer-mrxfdg.slurm
