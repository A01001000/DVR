...
3. The variants of the main model are included in separate folders, serving as tests for varying potential architectures of DVR. Modify the import statements in main2.py accordingly to try these versions
