...
class AdaptiveFlowPolicy_Medium(VLearnPolicy_Medium):
    def __init__(self, in_channels=131, use_checkpointing=True):
        ...
        self.max_flow_schedule = {
            "phase1": 12.0,   # Epochs 0-75: More aggressive exploration
            "phase2": 8.0,    # Epochs 76-125: Moderate refinement phase 
            "phase3": 3.0     # Epochs 126+: Fine-tuning phase
        }
    ...
    def get_current_max_flow(self):
        ...
        if self.epoch <= 25:  # Allow more aggressive early exploration
            return 10.0
        elif self.epoch <= 75:
