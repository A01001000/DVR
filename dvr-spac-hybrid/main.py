...
if __name__ == '__main__':
    ...
    if args.dataset_type is not None:
        dino_dir = os.path.join(args.model_dir, "Dino-Features", "Int-layer", f"{model_name}")
        model_dir = os.path.join(args.model_dir, "Ablation", "Int-layer", f"{model_name}")
    
    if args.use_raw_images:
        model_dir = os.path.join(args.model_dir, "Ablation", "Raw-img", f"{model_name}")
