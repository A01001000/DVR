...
def fit_pca_on_subset(dino_encoder, path_pairs, out_dim=24, samples_per_volume=100, target_size=(128, 192, 192), dataset_type=None, feature_type="standard"):
    """
        ...
        if dataset_type and dataset_type.lower() == "brain":
            ...
            if not os.path.exists(pca_hybrid_path):
                ...
                pca_hybrid_transformer = fit_pca_on_subset(
                    dino_encoder, path_pairs, out_dim=24, target_size=target_size, 
            ...
            if not os.path.exists(pca_path):
                pca_transformer = fit_pca_on_subset(dino_encoder, path_pairs, out_dim=24, target_size=target_size, dataset_type=dataset_type, feature_type="standard")
