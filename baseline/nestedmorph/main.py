...
def parse_args():
    ...
    parser.add_argument('--data_name', type=str, default="", help='Name of dataset')
...
# python main.py --t1_dir /path/to/t1 --dwi_dir /path/to/dwi --epochs 100 --img_size 64,64,64 --lr 2e-4 --batch_size 2 --cont_training --model_label NestedMorph --data_name MRXFDG
